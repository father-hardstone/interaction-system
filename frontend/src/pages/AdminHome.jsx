        ...
        <div className="max-w-[1200px] mx-auto my-8 px-8 w-full">
            <header className="bg-white p-6 rounded-2xl shadow-md mb-8 flex justify-between items-center flex-wrap gap-4">
                ...
                <div className="flex gap-4">
                    <button onClick={() => setShowCreateModal(true)} className="px-4 py-3 bg-primary text-white rounded-xl font-semibold text-base cursor-pointer transition-all shadow-lg shadow-blue-300/30 hover:bg-primary-dark hover:-translate-y-0.5 hover:shadow-xl hover:shadow-blue-400/40">
                        + New Entity
                    </button>
                    <button onClick={handleLogout} className="px-4 py-3 bg-red-500 text-white rounded-xl font-semibold text-base cursor-pointer transition-all hover:bg-red-600">
                        Logout
                    </button>
                </div>
            </header>
            ...
            <div className="mb-8">
                <input
                    ...
                    className="max-w-[400px] w-full py-3.5 px-4 border border-slate-200 rounded-xl font-inherit text-base bg-slate-50 transition-all text-slate-900 focus:outline-none focus:border-primary focus:bg-white focus:ring-4 focus:ring-blue-100"
                />
            </div>
                            ...
                            <tr key={entity.id} className="border-b border-slate-100">
                                ...
                                <td className="p-4 flex gap-2">
                                    ...
                                    <button
                                        ...
                                        className="bg-red-500 text-white border-none rounded-md px-3 py-2 cursor-pointer hover:bg-red-600 transition-colors"
                                    >
                                        Delete
                                    </button>
                                </td>

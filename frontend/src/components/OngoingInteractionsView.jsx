    ...
    return (
        <div className="space-y-6 h-full flex flex-col">
            {ongoingInteractions.map((interaction) => (
                <div key={interaction.id} className="bg-white rounded-xl shadow-sm border border-slate-200 flex flex-col h-full overflow-hidden">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 sm:p-6 bg-slate-50/50">
                        <div className="max-w-none mx-auto space-y-6 pb-20">
                            <SoapBlock
                                label="CC / Reason"
                                value={ccReason}

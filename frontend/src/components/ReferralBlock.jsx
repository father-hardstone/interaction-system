    ...
    return (
        <div className="space-y-4 bg-white p-5 rounded-2xl border border-slate-200 shadow-sm relative group transition-all hover:shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    <label className="text-xs font-semibold text-slate-400 normal-case tracking-[0.2em] mb-1.5 block px-1">Type of referral</label>
                    <select
                ...
                <div>
                    <label className="text-xs font-semibold text-slate-400 normal-case tracking-[0.2em] mb-1.5 block px-1">Description</label>
                    <input
                        type="text"
                ...
                <div>
                    <label className="text-xs font-semibold text-slate-400 normal-case tracking-[0.2em] mb-1.5 block px-1">Referred to</label>
                    <input
                        type="text"
                        className="w-full p-2.5 text-sm border border-slate-200 rounded-xl bg-slate-50 focus:bg-white focus:border-blue-500 transition-all font-medium"

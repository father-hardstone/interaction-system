          ...
          <fieldset disabled={isSubmitting} className="flex flex-col gap-5 border-0 p-0 m-0 min-w-0">
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setNewReceptionist((prev) => ({ ...prev, name: e.target.value }))
                }
                required
            ...
            <div className="flex flex-col gap-2">
              ...
              <PhoneInput onChange={setReceptionPhoneData} required />
            </div>
            <div className="flex flex-col gap-2">
              <label className="text-sm font-semibold text-slate-900">
            ...
            <div className="flex flex-col gap-2">
              ...
              <PasswordInput
                ...
                onChange={(e) =>
                  setNewReceptionist((prev) => ({ ...prev, password: e.target.value }))
                }
                required
              />
            </div>
